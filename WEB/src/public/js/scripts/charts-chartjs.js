...
$(window).on("load", function() {
    ...
    // Chart Data
    var chartData = {
       labels: ["Agentes activos", "Agentes pausa"],
       datasets: [
          {
             label: "My First dataset",
             data: [20, 5],
             backgroundColor: ["#00bcd4", "#ffa726"]
          }
    ...
    // Create the chart
    var pieChartAgentes = new Chart(ctx, config);

    // Pie chart
    // ----------------
    //Get the context of the Chart canvas element we want to select
    var ctx = $("#pie-chart-clientes");
    ...
    // Chart Data
    var chartData = {
       labels: ["Clientes activos", "Clientes espera"],
       datasets: [
          {
             label: "My First dataset",
             data: [60, 10],
    ...
    // Create the chart
    var pieChartClientes = new Chart(ctx, config);
